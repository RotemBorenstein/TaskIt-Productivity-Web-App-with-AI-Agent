...
urlpatterns = [
    ...
    path("api/assistant/inbox-status/", agent_views.assistant_inbox_status, name="assistant_inbox_status"),
    path("api/assistant/inbox/", agent_views.assistant_inbox_list, name="assistant_inbox_list"),
    path("api/assistant/inbox/<int:item_id>/read/", agent_views.assistant_inbox_mark_read, name="assistant_inbox_mark_read"),
